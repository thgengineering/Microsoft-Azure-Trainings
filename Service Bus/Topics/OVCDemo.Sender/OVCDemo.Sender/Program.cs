...
namespace OVCDemo.Sender
{
    class Program
    {
        ...
        {
            string ServiceBusConnectionString = "Endpoint=sb://ovc-demo-service-bus.servicebus.windows.net/;SharedAccessKeyName=Sender;SharedAccessKey=cd31GzmU5lJWjNYp8frWAF/+Q1WyMqwQBZDGZSkomDg=";
